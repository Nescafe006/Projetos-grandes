...
export default function GerenciarUsuarios() {
    ...
    const renderItem = useCallback(
        ({ item, index }: { item: typeof users[0]; index: number }) => {
                ...
                >
                    ...
                    >
                        ...
                        <View style={styles.actions}>
                            ...
                            <TouchableOpacity
                                style={styles.actionButton}
                                onPress={() => handleDelete(item.id)} // Função para excluir usuário
                            >
    ...
    const handleDelete = (id: string) => {
        // Função para excluir o usuário, pode ser implementada com lógica de backend
